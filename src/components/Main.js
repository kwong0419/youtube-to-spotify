  ...
  return (
    <div className="mainComponent">
      <div className="banner">
        ...
        {showQr ? (
          <img id="qrImg" alt="profileQr" src={`https://api.qrserver.com/v1/create-qr-code/?data=${userURI}&amp.png`} />
        ) : null}
      ...
      <div className="resultsList">
        <a href="https://open.spotify.com/" target="_blank">
          <img src={'https://www.flaticon.com/svg/static/icons/svg/2111/2111627.svg'} alt="spotImg" id="spotImg" />
        </a>
        <p>search term:</p> <input value={musictitle} onChange={(e) => setMusicTitle(e.currentTarget.value)} />
        <button onClick={redoSearch}>redo-search</button>
        {musicRes.length ? (
          <MusicCard result={musicRes} userAccessToken={userAccessToken} userURI={userURI} />
        ) : (
          <p style={{display: noVideoDisplay}}>oops! no result try a different video or redo search</p>
        )}
        <CircularProgress style={{display: progress}} />
        <a id="githubLink" href=" https://github.com/kwong0419/Music-Extension" target="_blank">
